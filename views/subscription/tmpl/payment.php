                ...
                <div class="tab-content">
                    ...
                    ?>
                        <div role="tabpanel" class="tab-pane active" id="availableCard">
                                <form action="<?php echo JRoute::_('index.php?option=com_itinerary&task=subscription.payment&tmpl=component'); ?>" method="post" id="payment-form-1">			
                                <div class="row group">
                    ...
                    ?>
                        <div role="tabpanel" class="tab-pane" id="newcard">
                            ...
                            <form action="http://nactustechnology.com/index.php?option=com_itinerary&task=subscription.payment&tmpl=component" method="post" id="payment-form-2">			
                        ...
                        <div role="tabpanel" class="tab-pane" id="newiban">                    
                            <!-- 2) Create your payment form-->
                            <form action="<?php echo JRoute::_('index.php?option=com_itinerary&task=subscription.payment&tmpl=component'); ?>" method="post" id="payment-form-3">
                                <div class="row group">
